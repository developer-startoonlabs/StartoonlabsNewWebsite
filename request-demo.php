          ...
          <div class="container">
            <div class="row">
              ...
              <div class="section-title">
                  ...
                  <p><b>Get a Virtual Demo By Filling Your Professional Information</b></p>
                     ...
                     <form method="post" action="contact-us.php" enctype="multipart/form-data">
                       <div class="requiredFields">* Required Fields</div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="hospital" class="form-control" id="exampleFormControlInput1" placeholder="Enter Hospital Name" required>
                        </div>
                        <div class="mb-3">
                            <label for="exampleFormControlInput1" class="form-label">Job Title<sup>*</sup></label>
                            <input type="text" name="title" class="form-control" id="exampleFormControlInput1" placeholder="Enter Job Title" required>
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                          ...
                          <div class="brochureDownload">
                              <button class="btn btn-theme btn-sm d-none d-md-inline-block" type="submit" name="submit">Request Demo</button>
                                </div>
                                         </form>
                                       </div>
...
<!--                    <p class="text-center" style="font-size: 23px;font-family:Segoe Ui;font-weight:600; color: #13152E;">Thank you for requesting a demo you will be hearing from us soon</p>-->
<!--                </div>-->
<!--            </div>-->
<!--        </div>-->
<!--    </div>-->
            ...
            <div class="modal-content"  style="padding: 1rem;border:none; background-color: #ffffff;box-shadow: 0 3px 10px rgb(0 0 0 / 0.2); margin-top: 8rem;">
                ...
                <div class="modal-body">
                   <img src="images/bg/Icon.png" style="height:120px;width:100px;margin-left:190px;margin-bottom:10px;"/>
                    ...
                    <p class="text-center" style="font-size: 21px;font-family:Segoe Ui;font-weight:700; color: #13152E;padding:0;line-height:1.3;">Thank you for requesting a demo you will be hearing from us soon</p>
                </div>
            </div>
        </div>
    </div>
