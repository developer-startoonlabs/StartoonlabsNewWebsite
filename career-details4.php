...
<?php } ?>
 ...
 <?php include('includes/header.php') ?>
            ...
            <div class="row">
              <div class="section-title">
                  ...
                  <div class="lookingFor">
                    ...
                    <ul>
                      <li>1. Working knowledge on Python script and Java script.</li>
                      <li>2. Hands-on with AWS Server  </li>
                      <li>3. Working knowledge on Mongo DB</li>
                      <li>4. Have good knowledge on MySQL </li>
                      <li>5. Hands on experience on HTML, CSS, Node JS. </li>
                      <li>6. Should be willing to learn upgrade to any technologies used in the project</li>
                    </ul>
                  </div>
                  ...
                  <div class="roles">
                    ...
                    <ul>
                      <li>1. Developing and implementing software applications </li>
                      <li>2. Developing software components and unit tests </li>
                      <li>3. Implementing new features based on business requirements</li>
                      <li>4. Developing and maintaining quality software product code </li>
                      <li>5. Troubleshooting, debugging and upgrading software</li>
                      <li>6. Ensure cross-platform compatibility and fixing issues during test and production phases</li>
                      <li>7. Stay updated with new tools, frameworks, approaches, and architectures in the development world</li>
    ...
    <!--                <p class="text-center" style="font-size: 23px;font-family:Segoe Ui;font-weight:600; color: #13152E;">Thank you for applying a job you will be hearing from us soon</p>-->
    <!--            </div>-->
    <!--        </div>-->
    <!--    </div>-->
    <!--</div>-->
