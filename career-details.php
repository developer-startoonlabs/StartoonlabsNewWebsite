            ...
            <div class="row">
              <div class="section-title">
                  ...
                  <div class="lookingFor">
                    ...
                    <ul>
                      <li>1. Bachelor's degree in Electronics </li>
                      <li>2. Hands-on experience with STM32, Nordic microcontrollers, sensors</li>
                      <li>3. Experience in C, Embedded C, Python, Matlab</li>
                      <li>4. Hands-on with RTOS plus NRF Modules</li>
                      <li>5. Tools: Seggar IDE, Keil IDE, AVR studio, STM Cube</li>
                      <li>6. Documentation skills</li>
                      <li>7. Analytical skills</li>
                    </ul>
                  </div>
                  ...
                  <div class="roles">
                    ...
                    <ul>
                      <li>1. Programming ARM cortex microcontrollers</li>
                      <li>2. Manage end-to-end development of wearable devices.</li>
                      <li>3. Good understanding of product functionality implementation</li>
                      <li>4. Responsible for development, testing, and integration</li>
                      <!--<li>5. An impressive portfolio/website/blog</li>-->
